...
--
-- Хост: 127.0.0.1
-- Час створення: Гру 10 2025 р., 10:46
...
(1, 'ORD1761735162', 2, 12, 420.00, '2025-10-29 12:52:42', '', NULL),
...
(8, 'ORD1765280579200', 1, 4, 200.00, '2025-12-09 12:42:59', '', NULL);
...
(10, 'Акваріум 60 л', 'Аксесуари', 2300.00, 4, 'Скляний акваріум із кришкою', 'https://images.prom.ua/4098646482_w640_h640_4098646482.jpg'),
(11, 'Фільтр для акваріума', 'Обладнання', 650.00, 4, 'Внутрішній фільтр для акваріума', 'https://content1.rozetka.com.ua/goods/images/big/411476355.jpg'),
(12, 'Обігрівач для акваріума', 'Обладнання', 480.00, 4, 'Терморегулятор із датчиком', 'https://content2.rozetka.com.ua/goods/images/big/18240249.jpg'),
...
(19, 'Кормушка для птахів', 'Аксесуари', 110.00, 7, 'Підвісна кормушка для птахів для вулеці або будинку', 'https://content.rozetka.com.ua/goods/images/big/462880153.jpg'),
...
(22, 'Кісточка-жувальна для собак', 'Ласощі', 60.00, 8, 'Натуральна жувальна кісточка', 'https://c.suziria.ua/32028-large_default/lasosshi-trixie-dlya-sobak-kistochka-zhuvalna-presovana-v-individualnij-upakovci-naturalna-shkira-15-sm-150-g-2-sht.jpg'),
(23, 'Печиво для котів', 'Ласощі', 75.00, 10, 'Снеки з куркою', 'https://i.moyo.ua/img/products/6729/38_1500.jpg?1758527858'),
...
(27, 'Корм-ласощі для екзотичних птахів Природа Лугові трави 140г', 'Корм', 95.00, 2, 'Корм-ласощі для дрібних екзотичних птахів', 'https://zoocool.ua/image/catalog/shop/products/88/31/3188/images/24439.jpg'),
...
(31, 'Ветеринарний Істинг', 'Ліки', 300.00, 10, 'ФІстинг за 300 баксів', 'https://static.wikitide.net/notbyliewikiwiki/thumb/3/34/%D0%92%D0%B0%D0%BD_%D0%94%D0%B0%D1%80%D0%BA%D1%85%D0%BE%D0%BB%D1%8C%D0%BC.jpg/800px-%D0%92%D0%B0%D0%BD_%D0%94%D0%B0%D1%80%D0%BA%D1%85%D0%BE%D0%BB%D1%8C%D0%BC.jpg'),
...
--
ALTER TABLE `inventory`
  MODIFY `inventory_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
